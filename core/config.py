...
class Config:
    ...
    def _setup(self):
        try:
            with open("config.toml", "rb") as file:
                ...
                self.storage = self._StorageConfig(downloads=data["storage"]["downloads"], database=data["storage"]["database"])
        except Exception:
    ...
    class _StorageConfig:
        def __init__(self, downloads: str = "downloads", database: str = "data.db"):
